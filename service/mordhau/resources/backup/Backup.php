<?php
    ...
    namespace GameDash\Sdk\Module\Implementation\Service\Mordhau\Resources\Backup;
            ...
            $Group = $this->Node->getFileSystem()->getFiles()->createGroup();
                ...
                $Group->addFile(
                    ...
                    new Node\FileSystem\File\Group\GroupFile(
                        ...
                        $this->Node->getFileSystem()->getFiles()->get( new Node\FileSystem\Path\Path( $this->Node, $RootDirectory->getPath()->toString() . '/Mordhau/Saved/Config/LinuxServer/Game.ini' ) ),
                        [ 'name' => 'Mordhau/Saved/Config/LinuxServer/Game.ini' ]
