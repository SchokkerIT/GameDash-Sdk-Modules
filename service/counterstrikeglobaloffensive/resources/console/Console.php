<?php
    ...
    namespace GameDash\Sdk\Module\Implementation\Service\CounterStrikeGlobalOffensive\Resources\Console;
    ...
    class Console extends Implementation\Service\Console\Console {
        ...
        public function getOutput( ?int $tail ): array {
            ...
            return map($ChildProcess->getIo()->getOutput( $tail ), static function( Node\Process\ChildProcess\Io\Output\Item $Item ): Instance\Console\Io\Output\Item {
