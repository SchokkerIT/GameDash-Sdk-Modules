<?php
    ...
    namespace GameDash\Sdk\Module\Implementation\Service\CounterStrikeSource\Resources\Backup;
            ...
            $Group = new Node\FileSystem\File\Group\Group( $this->Node );
                ...
                $Group->addFile(
                    ...
                    new Node\FileSystem\File\Group\GroupFile(
                        ...
                        $this->Node->getFileSystem()->getFiles()->get( new Node\FileSystem\Path\Path( $this->Node, $RootDirectory->getPath()->toString() . '/cstrike/cfg' ) ),
                        [ 'name' => '/cstrike/cfg' ]
                ...
                $Group->addFile(
                    ...
                    new Node\FileSystem\File\Group\GroupFile(
                        ...
                        $this->Node->getFileSystem()->getFiles()->get( new Node\FileSystem\Path\Path( $this->Node, $RootDirectory->getPath()->toString() . '/cstrike/maps' ) ),
                        [ 'name' => '/cstrike/maps' ]
                ...
                $Group->addFile(
                    ...
                    new Node\FileSystem\File\Group\GroupFile(
                        ...
                        $this->Node->getFileSystem()->getFiles()->get( new Node\FileSystem\Path\Path( $this->Node, $RootDirectory->getPath()->toString() . '/cstrike/sound' ) ),
                        [ 'name' => '/cstrike/sound' ]
