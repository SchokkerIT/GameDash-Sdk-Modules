<?php
    ...
    namespace GameDash\Sdk\Module\Implementation\Service\PostScriptum\Resources\Name;
    ...
    class Name extends Implementation\Service\Name\Name {
        ...
        public function set( string $name ): void {
            ...
            $ServerProperties = $this->FileSystem->getConfigEditor()->getFiles()->get(
                ...
                new FileSystem\Path\Path($this->Instance, '/PostScriptum/ServerConfig/Server.cfg')
