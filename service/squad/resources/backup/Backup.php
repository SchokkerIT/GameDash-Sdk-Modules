<?php
    ...
    namespace GameDash\Sdk\Module\Implementation\Service\Squad\Resources\Backup;
            ...
            $Group = new Node\FileSystem\File\Group\Group( $this->Node );
                ...
                $Group->addFiles([
                    ...
                    new Node\FileSystem\File\Group\GroupFile(
                        ...
                        $this->Node->getFileSystem()->getFiles()->get( new Node\FileSystem\Path\Path( $this->Node, $RootDirectory->getPath()->toString() . '/SquadGame' ) ),
                        [ 'name' => '/SquadGame' ]
