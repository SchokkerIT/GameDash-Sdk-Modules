<?php
    ...
    namespace GameDash\Sdk\Module\Implementation\Service\Unturned\Resources\Backup;
        ...
        public function getFileGroup(): Node\FileSystem\File\Group\Group {
            ...
            $Group->addFiles([
                ...
                new Node\FileSystem\File\Group\GroupFile(
                    ...
                    $this->Node->getFileSystem()->getFiles()->get( new Node\FileSystem\Path\Path( $this->Node, $RootDirectory->getPath()->toString() . '/Servers' ) )
